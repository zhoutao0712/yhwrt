...
var movistarTriple_support_models = ["BRT-AC828", "RT-AC5300", "GT-AC5300", "RT-AC3200", "RT-AC3100", "RT-AC1200G+", "RT-AC88U", "RT-AC87U", "RT-AC68U", 
									 "RT-AC68A", "4G-AC68U", "RT-AC66U", "RT-AC56U", "RT-AC56S", "RT-AC51U", "RT-N66U", "RT-N18U", "BLUECAVE", "RT-AC51U+"];
...
tabtitle[6] = new Array("", "<#BOP_isp_heart_item#>", "<#vpnc_title#>", "TOR", "CG");
...
tablink[6] = new Array("", "Advanced_VPN_PPTP.asp", "Advanced_VPNClient_Content.asp", "Advanced_TOR_Content.asp", "Advanced_TINC_Content.asp");
...
function show_menu(){
	...
	if(sw_mode == 2){
		...
		else if(gobi_support && noWAN_support)
			menu1_code += '<div class="m_qis_r" style="margin-top:-170px;cursor:pointer;" onclick="go_setting(\''+ QISWIZARD +'?flag=welcome\');"><table><tr><td><div id="index_img0"></div></td><td><div><#QIS#></div></td></tr></table></div>\n';
		else
...
function addOnlineHelp(obj, keywordArray){
	...
	if(obj){
		obj.href = "https://www.asus.com"+faqLang.<% nvram_get("preferred_lang"); %>;
...
function cal_height(){
	...
	// index.asp
		...
		if(usbPortMax == 3) table_height = 1060;
		table_height = (table_height < 930) ? 930 : table_height;
...
function refreshStatus(xhr){
	...
	if(sw_mode == 1){
		...
		if(location.pathname == "/" || location.pathname == "/index.asp"){
			if(wlc_band == 0 || wlc_band == -1) {	// show repeater and media bridge date rate. -1 is for default.
