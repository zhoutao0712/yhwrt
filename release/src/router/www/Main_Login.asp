...
<div class="div_table main_field_gap">
	<div class="div_tr">
		...
		<div id="login_filed">
			...
			<div class="title_gap">
				<input type="text" id="login_username" readonly="1" name="login_username" tabindex="1" class="form_input" maxlength="20" value="admin" autocapitalize="off" autocomplete="off" placeholder="<#HSDPAConfig_Username_itemname#>">
			</div>
