...
struct nvram_tuple router_defaults[] = {
	...
	{ "wl_phytype", "v", 0 },		/* Current wireless band ("a" (5 GHz),"v"(5GHz ac)
...
//#endif /* __CONFIG_802_11U__ */
	...
	{ "wl_country_code", DEF_COUNTRY_CODE, 0 },
#endif
...
// WEP data encryption 0, 1, 2 : disabled/5/13
...
#if defined(RTAC53U) || defined(RTAC1200G) || defined(RTAC1200GP) || defined(RPAC68U)
	...
	{ "wl_mumimo", "1", 0 },
#elif defined(RTCONFIG_QTN) || defined(RTCONFIG_MUMIMO)  || defined(RTCONFIG_MUMIMO_2G) || defined(RTCONFIG_MUMIMO_5G)
	{ "wl_mumimo", "0", 0 },
#endif
...
//#ifdef RTCONFIG_SWITCH_CONTROL_8367
...
#if ((defined(RTCONFIG_INTERNAL_GOBI) || defined(RTCONFIG_WANPORT2)) && !defined(RTCONFIG_NO_WANPORT))
	{ "wans_mode", "lb" },
#else
	...
	{ "wans_dualwan", DEF_SECOND_WANIF " none" },
#else
...
// the following variables suppose can be removed
	...
	{ "dslx_dhcp_hostname", "" },	//DHCP option 12
...
//#endif
	...
	{ "sshd_authkeys", "" },
#endif
	{ "shell_timeout", "1200" },	/* telnet/ssh autologout idle timeout, sec. */
	...
	{ "wl_lrc",			"2" },
#endif
	{ "rast_idlrt",			"20" },		/* roaming assistant idle rate (Kbps) */
#endif
