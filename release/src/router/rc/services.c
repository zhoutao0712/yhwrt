...
/* [MUST] : Need to clarify .... */
	if (nvram_get_int("sw_mode") == SW_MODE_AP && nvram_get_int("wlc_psta") == 1 && nvram_get_int("wlc_state") != WLC_STATE_CONNECTED && !nvram_match("lan_proto", "static")) { // Media bridge
		lan_ipaddr = nvram_default_get("lan_ipaddr");
	}
	else
#endif
...
/* [MUST]: Need to clarify ..... */
	{
		if (!(nvram_get_int("sw_mode") == SW_MODE_AP && nvram_get_int("wlc_psta") == 1)) // Skip media bridge mode
			return;
	}
#else
		return;
...
#ifdef RTCONFIG_REALTEK
/* [MUST] : Need to clarify ..... */
	&& !(nvram_get_int("sw_mode") == SW_MODE_AP && nvram_get_int("wlc_psta") == 1) // skip media bridge
#endif
	)
#endif
	{
...
#ifdef RTCONFIG_REALTEK
/* [MUST] : Need to Clarify ... */
	 || (nvram_get_int("sw_mode") == SW_MODE_AP && nvram_get_int("wlc_psta") == 1 && nvram_get_int("wlc_state") != WLC_STATE_CONNECTED)
#endif
#endif
	) {
...
#ifdef RTCONFIG_REALTEK
/* [MUST] : Need to Clarify ...  */
		|| (nvram_get_int("sw_mode") == SW_MODE_AP && nvram_get_int("wlc_psta") == 1 && nvram_get_int("wlc_state") != WLC_STATE_CONNECTED) // Media bridge
#endif
		)
		{
...
#endif /* CONFIG_ASUS_DUAL_IMAGE_ENABLE */
